...
VertexColorPipeline::VertexColorPipeline(VulkanContext& context, const VkExtent2D& extent, VkRenderPass renderPass,
...
VertexColorPipeline::~VertexColorPipeline() = default;
